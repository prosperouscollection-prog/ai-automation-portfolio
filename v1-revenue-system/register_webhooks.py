...
if resp.status_code in (200, 201):
    ...
    print("\nCALENDLY: PASS (already registered — 409 Conflict means webhook exists)")
else:
    print("\nCALENDLY: FAIL")
...
if stripe_pass:
    ...
    print(f"\nSTRIPE: FAIL — no active endpoint found for {N8N_STRIPE_WEBHOOK}")
    print("  Action: Stripe → Developers → Webhooks → Add endpoint")
    print(f"  URL: {N8N_STRIPE_WEBHOOK}")
